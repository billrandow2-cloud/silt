...
// Obter lista de meses únicos dos dados (mais recente primeiro)
function getUniqueMonths() {
    const months = new Set();
    allRankingData.forEach(r => months.add(r.month));
    // Filtra pelos meses que existem e ordena do mais recente para o mais antigo
    return PT_MONTHS.filter(m => months.has(m)).reverse();
}
